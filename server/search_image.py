...
def extract_vector_stream(model,bytes):
...
paths_vkl ="/content/drive/MyDrive/Breast_Cancer_Detection/Code/Thuan/ImageRetrival/MiAI_Image_Search/paths.pkl"
vector_vkl ="/content/drive/MyDrive/Breast_Cancer_Detection/Code/Thuan/ImageRetrival/MiAI_Image_Search/vectors.pkl"


def handle_predict(bytesImage):
    model = get_extract_model()
    search_vector = extract_vector_stream(model=model,bytes=bytesImage)
    vectors = pickle.load(open(vector_vkl,"rb"))
    paths = pickle.load(open(paths_vkl,"rb"))
